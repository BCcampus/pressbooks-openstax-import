...
/**
 * must also load the class outside of the admin_notices or network_admin_notices hooks.
 * The reason is that these hooks come after the admin_enqueue_script hook that loads the javascript.
 */
